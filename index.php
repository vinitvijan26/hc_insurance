<?php 
    ...
    {
        header ("LOCATION:mem_home.php");   //admin_home.php
    }
...
?>
  ...
  <div class="container ">
    <center>
      <div class="col-md-4">
        <img src="assets/img/index_awards1.png" align="center" data-toggle="modal" data-target="#myModal3" style="width:50%" alt="index_awards1.png" class="img-medium w3-circle w3-hover-opacity"/>
